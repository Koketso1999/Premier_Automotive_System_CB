...
<table class="table">
	<tr>
    	<th class="title_cell">Title</th>
        <th align = "center">Nb. Replies</th>
        <th align = "center">Participant</th>
        <th align = "center">Date or creation</th>
    </tr>
<?php
...
?>
	...
	echo "<tr>";
	?>
    	<th class='rows'><a href="read_pm.php?id=<?php echo $dn2['id']; ?>"><?php echo htmlentities($dn2['title'], ENT_QUOTES, 'UTF-8'); ?></a></th>
    	<th class='rows'><?php echo $dn2['reps']-1; ?></th>
    	<th class='rows'><a href="profile.php?id=<?php echo $dn2['userid']; ?>"><?php echo htmlentities($dn2['username'], ENT_QUOTES, 'UTF-8'); ?></a></th>
    	<th class='rows'><?php echo date('Y/m/d H:i:s' ,$dn2['timestamp']); ?></th>
    <?php
	echo "<tr>";
	?>
<?php
