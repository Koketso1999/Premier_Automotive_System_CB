                            ...
                            <ul class="menu-items">
                                ...
                                <div class="login-body1">
                                    <div class="center1">
                                        ...
                                        <label for="click1" class="click-me1">Login</label>

                                        <div class="content1">
                                            <div class="head1">
                                                <h2 class="login-head1"> Premier Automotive</h2>
                        ...
                        <div class="table-cell">
                            ...
                            <div class="login-body">
                                <div class="center">
                                    ...
                                    <div class="content">
                                        <div class="head">
                                            <h2 class="login-head"> Premier Automotive</h2>
        ...
        <div class="row">
          <div class="col">
            <h1>
              ...
              <ul>
                  <li> <p class="text-danger">Put your mask on all the time</p></li>
                  <li>Wash your hands regularly with soap and clean water, or clean them with alcohol-based hand rub/sanitizer</li>
                  <li>Maintain at least 2 metres distance between you and other people</li>
